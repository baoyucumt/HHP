from ObjectiveFunction import OBJFUN as obj
import numpy as np
import random
import copy
...
class GAGene:
    ...
    def generate(self):
        ...
        '''
        len = self.vardim
        rnd = np.random.randint(size=len)
...
class GeneticAlgorithm:
    ...
    def selectionOperation(self):
        ...
        sum1 = 0.      #累加 self.fitness[i] / totalFitness
        for i in range(0, self.sizepop):
        ...
        for i in range(0, self.sizepop, 2):
            ...
            if r < self.params[0]:
                ...
                for j in range(crossPos, self.vardim):
                    newpop[i].chrom[j] = newpop[i].chrom[     #newpop[i]就是population[i]
